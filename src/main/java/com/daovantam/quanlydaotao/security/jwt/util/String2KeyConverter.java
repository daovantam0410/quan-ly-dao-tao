...
public final class String2KeyConverter {
    ...
    /*
    Chức năng Function getPrivateKey() giống chức năng của Function getPrivateKey() trong Class KeyReader
    */
    ...
    /*
    Chức năng Function getPublicKey() giống chức năng của Function getPublicKey() trong Class KeyReader
    */
